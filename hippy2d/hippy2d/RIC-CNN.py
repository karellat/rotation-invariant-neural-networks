...
class Rot_Inv_ConvNet(nn.Module):
    def __init__(self, BATCH_SIZE, input_size=32, num_classes=10):
...
def get_rot_inv_cnn(BATCH_SIZE, input_size=32, num_classes=10):
    return Rot_Inv_ConvNet(BATCH_SIZE, input_size=input_size, num_classes=num_classes)
